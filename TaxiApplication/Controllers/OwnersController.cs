...
namespace TaxiApplication.Controllers
{
    public class OwnersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ownerID,FirstName,LastName,Gender,Address,PhoneNumber,Email")] Owner owner)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ownerID,FirstName,LastName,Gender,Address,PhoneNumber,Email")] Owner owner)
        {
            if (ModelState.IsValid)
            {
