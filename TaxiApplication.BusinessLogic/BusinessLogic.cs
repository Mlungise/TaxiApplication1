...
namespace TaxiApplication.BusinessLogics
{
    public class BusinessLogic
    {
        ...
        public List<Price> getRouteDetails(int rid)
        {
            return db.Prices.ToList().FindAll(x => x.RouteId == rid);
        }
        
        public List<Available> passengerAvail(int rid)
        {
            return db.Availables.ToList().FindAll(x => x.schedule.RouteId == rid);
        }
